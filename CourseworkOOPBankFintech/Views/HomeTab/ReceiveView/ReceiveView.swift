    ...
    var body: some View {
        VStack {
            ...
            Button {
                ...
                coordinator.dismissSheet(sheet: .receiveSheetView)
                sendIsFocused = false
            } label: {
                ZStack {
...
#Preview {
    ReceiveView(card: Card(_color: "", _name: "", _coins: 0.00, _creationDate : Date.now, _expirationDate: Date.distantPast, _tokenCode: 572, _logoCard: .mastercard))
        .environmentObject(ReceiveViewModel())
}
